...
(2, 'djc', 'djcn', 211, '2023-02-09', '2023-02-16', 120000),
(3, 'dhvh', 'dcdc', 1111, '2023-02-06', '2023-02-06', 150000),
(4, 'abc', 'Upin', 2025, '2023-02-02', '2023-02-02', 1500000);
...
--
ALTER TABLE `tb_dvd`
  MODIFY `id_dvd` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
